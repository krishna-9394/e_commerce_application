...
class CategoryControllerAdmin extends GetxController {
  static CategoryControllerAdmin get instance => Get.find();

  final uploadsRepository = Get.put(CategoryUploadsRepository());
