...
class CategoryUploadsRepository extends GetxController {
  static CategoryUploadsRepository get instance => Get.find();
  ...
  Future<void> uploadCategoryData(CategoryModel category) async {
    try {
      ...
      category.id = id;
      await _db.collection("categories").doc(id).set(category.toJson());
    } on FirebaseException catch (e) {
      throw TFirebaseException(e.toString());
    } on FormatException catch (e) {
      throw TFormatException(e.toString());
